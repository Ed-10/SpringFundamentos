...
public class ProductoService {
    ...
    {   //Es Integer por que en nuestro modelo se registro como Integer
    ...
    {   //Integer, esto viene de nuestro modelo CategoriaModel.java
    ...
    //Creando metodo para poder LISTAR nuestras CATEGORIAS WHERE-IN
